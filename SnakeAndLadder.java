...
class Dice {
    ...
    /*
     * TODO 1: Generate a random number from 1 to 'sides'.
     */
    public int roll() {
        // Write your dice rolling logic here
...
class Board {
    ...
    public Board(int size) {
        this.size = size;
        /*
         * TODO 2: Initialize the 'jumps' map
         */
    ...
    /*
     * TODO 3: Unifying Mechanics (Logic)
    ...
    public int getFinalPosition(int position) {
        // Write logic to return final position after checking for snakes/ladders
    ...
    // --- PRE-POPULATED HELPER METHOD ---
    public int getSize() {
        return size;
    }
}

// === GAME ENGINE (Pre-populated) ===
class GameEngine {
...
public class SnakeAndLadder{
    public static void main(String[] args) {
         ...
         * - Play the game 
         */
        // Write your setup and execution logic here
